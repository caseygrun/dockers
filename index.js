...
(function() {
  var async, buildArguments, formats, getFormatOptions, me, pandoc, pdc, pdcToFile, pipeline, pth, runPandoc, spawn, tempFile, tmp, _;
  ...
  buildArguments = function(opt) {
    var args, key, value, _i, _len;
    args = [];
    for (value = _i = 0, _len = opt.length; _i < _len; value = ++_i) {
      key = opt[value];
      if (key === 'to') {
        key = '-t';
      }
